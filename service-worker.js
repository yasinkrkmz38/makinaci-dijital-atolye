const VERSION='dm-v16.2.0';
const SHELL=['/','/style.css?v=16.2.0','/app.js?v=16.2.0','/manifest.webmanifest?v=16.2.0','/forgot-password.html','/reset-password.html','/icon-192.png','/icon-512.png'];
