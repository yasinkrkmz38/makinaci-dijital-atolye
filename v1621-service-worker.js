const VERSION='dm-v16.2.1';
const SHELL=['/','/v1621-style.css?v=16.2.1','/v1621-app.js?v=16.2.1','/manifest.webmanifest?v=16.2.1','/forgot-password.html','/reset-password.html','/icon-192.png','/icon-512.png'];
